...
const char programID[]="OttoPlus_v1.2"; //Each program will have a ID
    ...
    switch (MODE) {
      ...
      case 2:
        ...
        if(obstacleDetected){
           ...
           if((obstacleDetected)||(buttonPushed)){break;}
           else{
              otto.putMouth(smile);
              delay(50);
              obstacleDetector();
